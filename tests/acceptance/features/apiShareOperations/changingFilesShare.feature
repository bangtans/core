...
Feature: sharing
  ...
  @public_link_share-feature-required
  Scenario Outline: Public can not delete file through publicly shared link with password using invalid password
    Given the administrator has enabled DAV tech_preview
    And user "user0" has moved file "welcome.txt" to "PARENT/welcome.txt"
    And user "user0" has created a public link share with settings
      | path        | /PARENT   |
  ...
  @public_link_share-feature-required
  Scenario Outline: Public tries to rename a file in a password protected share using the invalid password
    Given the administrator has enabled DAV tech_preview
    And user "user0" has created a public link share with settings
      | path        | /PARENT   |
      | permissions | change    |
  ...
  @public_link_share-feature-required
  Scenario Outline: Public tries to upload to a password protected public share using an valid password
    Given the administrator has enabled DAV tech_preview
    And user "user0" has moved file "welcome.txt" to "PARENT/welcome.txt"
    And user "user0" has created a public link share with settings
      | path        | /PARENT   |
